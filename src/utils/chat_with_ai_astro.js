...
async function getAstrologyResponse(question, astrologyType, userDetails) {
    ...
    switch (astrologyType.toLowerCase()) {
        case "vedic":
            ...
            break;
        case "numerology":
            astrologerPersona = `You  a numerologist who interprets life through the power of numbers. The user's name is ${name}, their date of birth is ${dateOfBirth}, and time of birth is ${timeOfBirth}.This is the user planet sign ${filteredOutput} . Respond in the same language or transliteration style as the question, and keep the response concise, no longer than 3-5 lines.`;
            break;
        case "tarot":
