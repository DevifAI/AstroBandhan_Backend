  ...
  io.on("connection", (socket) => {
    ...
    socket.on(
      ...
      async ({
        ...
        const response = await axios.post(
          "https://devifai.in/astrobandhan/v1/user/start/call",
          payload
        );
    ...
    socket.on("endaudiocall", async ({ callId, astrologerId, userId }) => {
      try {
        ...
        const apiUrl = "https://devifai.in/astrobandhan/v1/user/end/call";
        ...
        console.error("Error handling end audio call:", error.message);
      }
    });
